...
local function CreateCopyButton(self)
    ...
    self.Copy:SetNormalTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\ChatCopyNormal')
    self.Copy:GetNormalTexture():SetSize(20, 20)

    self.Copy:SetHighlightTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\ChatCopyHighlight')
