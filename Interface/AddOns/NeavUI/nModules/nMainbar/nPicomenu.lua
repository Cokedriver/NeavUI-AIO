...
if (not C['nMainbar'].showPicomenu) then
    return
end
...
local menuList = {
    ...
    },
    {
        ...
        -- icon = 'Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\picomenuTalents',
        func = function() 
...
f:SetNormalTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\picomenuNormal')
f:GetNormalTexture():SetSize(30, 30)

f:SetHighlightTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\picomenuHighlight')
