...
for i = 1, 12 do
    for _, button in pairs({        
        ...
        button:SetScale(C['nMainbar'].totemManager.scale)
        button:SetAlpha(C['nMainbar'].totemManager.alpha)
...
MultiCastFlyoutFrame:SetScale(C['nMainbar'].totemManager.scale * 1.1)
...
if (C['nMainbar'].totemManager.hideRecallButton) then
