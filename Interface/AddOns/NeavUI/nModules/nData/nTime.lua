...
if C['nData'].wowtime and C['nData'].wowtime > 0 then
	...
	local function CalculateTimeValues(tt)
		...
		local Hr, Min, AmPm
		if tt == true then
			if C['nData'].localtime == true then
				Hr, Min = GetGameTime()
				if C['nData'].time24 == true then
					return Hr, Min, -1
				else
					if Hr>=12 then
	...
	Stat:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddLine(hexa..N.myname.."'s"..hexb.." Time")
		GameTooltip:AddLine' '	
