...
if C['nCore'].quicky ~= true then return end
...
f.Head:SetNormalTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyNormal')
f.Head:SetHighlightTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyHighlight')
f.Head:SetPushedTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyPushed')
...
f.Cloak:SetNormalTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyNormal')
f.Cloak:SetHighlightTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyHighlight')
f.Cloak:SetPushedTexture('Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\QuickyPushed')
