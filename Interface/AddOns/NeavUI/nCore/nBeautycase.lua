...
local addonName = select(1, GetAddOnInfo('NeavUI'))
local formatName = '|cffFF0000'..addonName

local textureNormal = 'Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\BorderNormal'
local textureWhite = 'Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\BorderNormalWhite'
local textureShadow = 'Interface\\AddOns\\NeavUI\\nMedia\\nTextures\\BorderShadow'
