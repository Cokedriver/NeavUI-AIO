...
if (not C['mainbar'].showPicomenu) then
    return
end
...
local menuList = {
    ...
    },
    {
        ...
        -- icon = 'Interface\\AddOns\\NeavUI\\Media\\picomenuTalents',
        func = function() 
    ...
    },
    {
        ...
        icon = 'Interface\\AddOns\\NeavUI\\Media\\picomenuAchievement',
        func = function() 
...
f:SetNormalTexture('Interface\\AddOns\\NeavUI\\Media\\picomenuNormal')
f:GetNormalTexture():SetSize(30, 30)

f:SetHighlightTexture('Interface\\AddOns\\NeavUI\\Media\\picomenuHighlight')
