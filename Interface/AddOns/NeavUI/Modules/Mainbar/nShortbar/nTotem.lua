...
if (not C['mainbar'].MainMenuBar.shortBar and not C['mainbar'].MainMenuBar.moveableExtraBars) then
    return
end
...
for i = 1, 12 do
    for _, button in pairs({        
        ...
        button:SetScale(C['mainbar'].totemManager.scale)
        button:SetAlpha(C['mainbar'].totemManager.alpha)
...
MultiCastFlyoutFrame:SetScale(C['mainbar'].totemManager.scale * 1.1)
...
if (C['mainbar'].totemManager.hideRecallButton) then
