...
ConsolidatedBuffsCount:SetFont('Fonts\\ARIALN.ttf', C['buff'].buffFontSize+2, 'THINOUTLINE')
...
for i = 1, NUM_TEMP_ENCHANT_FRAMES do
    ...
    border:SetTexture(C['buff'].borderDebuff)
    ...
    button.Shadow:SetTexture('Interface\\AddOns\\NeavUI\\Media\\BuffShadow')
