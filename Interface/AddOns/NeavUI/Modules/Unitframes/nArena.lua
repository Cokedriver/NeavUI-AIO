...
if (not C['unitframes'].units.arena.show) then
    return
end
...
local function CreateArenaLayout(self, unit)
    ...
    self.Texture:SetTexture('Interface\\AddOns\\NeavUI\\Media\\arenaFrameTexture')
    ...
    if (self.arenaUnit) then
        ...
        self.Castbar.Icon:SetSize(C['unitframes'].units.arena.castbar.icon.size, C['unitframes'].units.arena.castbar.icon.size)
        ...
        self.Castbar.Icon.Shadow:SetTexture('Interface\\AddOns\\NeavUI\\Media\\borderBackground')
    ...
    if (self.targetUnit) then
        ...
        self.Texture:SetTexture('Interface\\AddOns\\NeavUI\\Media\\customTargetTargetTexture')
    ...
    self:SetScale(C['unitframes'].units.arena.scale)
