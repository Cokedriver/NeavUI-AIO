...
f.Head:SetNormalTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyNormal')
f.Head:SetHighlightTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyHighlight')
f.Head:SetPushedTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyPushed')
...
f.Cloak:SetNormalTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyNormal')
f.Cloak:SetHighlightTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyHighlight')
f.Cloak:SetPushedTexture('Interface\\AddOns\\NeavUI\\Media\\QuickyPushed')
